                        ...
                        SliverOverlapAbsorber(
                          ...
                          sliver: SliverAppBar(
                            ...
                            flexibleSpace: FlexibleSpaceBar(
                                    ...
                                    child: DropdownButton<PLanguage>(
                                      ...
                                      items: [
                                        DropdownMenuItem(
                                          ...
                                          child: Image.network(
                                            'https://cdn.countryflags.com/thumbs/united-kingdom/flag-waving-250.png',
                                            fit: BoxFit.cover,
                                          ),
                                        ),
                                        DropdownMenuItem(
                                          ...
                                          child: Image.network(
                                            'https://cdn.countryflags.com/thumbs/uzbekistan/flag-waving-250.png',
                                            fit: BoxFit.cover,
                                          ),
                                        )
                                      ],
                              ...
                              background: currentLanguage == PLanguage.english
                                  ? Image.network(
                                      'https://what5.files.wordpress.com/2017/02/ay103599038mps-lords-and-me.jpg',
                                      fit: BoxFit.cover,
                                    )
                                  : Image.network(
                                      'https://i.pinimg.com/originals/7e/e5/e4/7ee5e416484e6116d2bdfc6155e078cb.jpg',
                                      fit: BoxFit.cover,
                                    ),
                            ),
                          ),
...
class _SliverAppBarDelegate extends SliverPersistentHeaderDelegate {
  ...
  @override
  double get minExtent => _tabBar.preferredSize.height + 90;
  @override
  double get maxExtent => _tabBar.preferredSize.height + 90;
