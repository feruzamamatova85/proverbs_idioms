...
class _FilterListWidgetState extends State<FilterListWidget> {
  ...
  List<String> _leftText;
  List<String> _rigthText;
  ...
  void initState() {
    ...
    _selectedTextList = widget.selectedTextList != null
        ...
        : [];
    int half = int.parse((_allTextList.length / 2).toStringAsFixed(0));

    _leftText = List.from(_allTextList.getRange(0, half));
    _rigthText = List.from(_allTextList.getRange(half, _allTextList.length));

    _controllers = LinkedScrollControllerGroup();
    _leftScroll = _controllers.addAndGet();
    _rightScroll = _controllers.addAndGet();
                    ...
                    children: [
                      Expanded(
                        child: ListView(
                          ...
                          children: _buildChoiceList(_leftText),
                        ),
                      ),
                      SizedBox(
                        width: 5,
                      ...
                      Expanded(
                        child: ListView(
                          ...
                          children: _buildChoiceList(_rigthText),
                        ),
                      ),
                    ],
                  ),
